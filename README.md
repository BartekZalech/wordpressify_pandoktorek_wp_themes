# MobilitySoft
## WordPressify startet Windows linux
1. Run mysql service
...
4. exit mysql \
`exit;`
5. npm i / yarn install
6. remove folder .git
7. `git init` 
8. `git add`
9. `git commit -m "init project"` 
10. edit gulpfile.js line 26 change name yor themes
11. edit src/assets/styles/style.scss change data about editor and theme name
12. `npm run install:wordpress / yarn run install:wordpress`
13. `npm run dev / yarn run dev` 
<hr>

After run script you has access to 2 ports 3010 and 3020 \
3010 -> it's hot reaload user for development themes/plugins\
3020 -> it's static used for login to wp-admin \
to login admin pannel and don't have error use :3020/wp-login 
<hr>
